...
const MobileNavMenu = () => {
  ...
  return (
    <nav className="bg-valge h-screen w-screen absolute top-0 left-0 z-20 ">
      <div className="flex flex-col flex-wrap items-center h-full">
        ...
        <Link to="/"> <div onClick={() => dispatch({ type: "switchNavMenu", payload: false })} className="mt-[31.5px] ml-[24px]">
